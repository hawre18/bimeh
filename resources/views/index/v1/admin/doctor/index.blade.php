                                ...
                                @foreach($doctors as $doctor)
                                    <tr>
                                        ...
                                        <td class="text-end p-3">
                                            ...
                                            <a href="{{route('doctor.delete',$doctor->id)}}" class="btn btn-icon btn-pills btn-soft-danger" data-bs-toggle="modal" data-bs-target="#cancelappointment"><i class="uil uil-times-circle"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
