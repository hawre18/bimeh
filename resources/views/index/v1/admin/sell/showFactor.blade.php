...
<body>
<div class="limiter">
    <label>{{\Hekmatinasser\Verta\Verta::today())}}</label>
        ...
        <div class="wrap-table100">
            <div class="table100">
                <table>
                    ...
                    <tbody>
                    <tr>
                        <td class="column2">{{\Hekmatinasser\Verta\Verta::instance($sell->created_at)->formatJalaliDatetime(\Hekmatinasser\Verta\Verta::today('Asia/Tehran'))}}</td>
                        ...
                        <td class="column6">{{$sell->doctor->fname ." "}}{{$sell->doctor->lname}} </td>
