                            ...
                            <table class="table mb-0 table-center">
                                ...
                                @foreach($addresses as $address)
                                    <tr>
                                        ...
                                        <td class="p-3">{{$address->customer['f_name']}}</td>
                                        <td class="p-3">{{$address->bodyad}}</td>
                                        <td class="p-3"> {{$address->province->name}} </td>
                                        <td class="p-3">{{$address->created_at}}</td>
                                        <td class="text-end p-3">
                                            ...
                                            <a href="{{route('address.delete',$address->id)}}" class="btn btn-icon btn-pills btn-soft-danger" ><i class="uil uil-times-circle"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
