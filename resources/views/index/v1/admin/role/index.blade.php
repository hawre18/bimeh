                                ...
                                @foreach($roles as $role)
                                    <tr>
                                        ...
                                        <td class="text-end p-3">
                                            ...
                                            <a href="{{route('role.delete',$role->id)}}" class="btn btn-icon btn-pills btn-soft-danger" data-bs-toggle="modal" data-bs-target="#cancelappointment"><i class="uil uil-times-circle"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
